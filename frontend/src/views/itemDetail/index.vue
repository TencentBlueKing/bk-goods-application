<template>
    <div class="itemDetail-wrapper">
        ...
        <div class="good-info-wapper">
            <div class="good-pic">
                ...
                <div class="pic-list">
                    <div
                        class="pic-slide-btn"
                        :class="{ 'ban-btn': slideIndex.nowFirst === 1 }"
                        @click="picSlide('forward')"
                    >
                    ...
                    <div class="pic-item-wapper">
                        <ul id="item-list">
                            <li
                                v-for="(item, index) in goodPicList"
                                :key="index"
                                @mouseover="
                                    picMouseOver('pic-item' + index, item)
                                "
                            >
                                <img
                                    :id="'pic-item' + index"
                ...
                <div class="info-content-wapper">
                    ...
                    <div class="info-detail">
                        <div
                            ...
                            :key="index"
                            v-show="item.value !== '正常'"
                        >
                            <div class="detail-title">{{ item.title }}</div>
                            <div class="detail-value">{{ item.value }}</div>
                        </div>
                    </div>
                    <div class="buy-goods" v-if="!isAdmin">
                        <bk-input
                            class="count-btn"
                            type="number"
                            :max="1000"
        ...
        <div class="good-detail-wapper">
            ...
            >
                <bk-tab-panel
                    v-for="(panel, index) in detailPanels"
                    v-bind="panel"
                    :key="index"
                >
                    <v-md-preview
                        v-if="index === 0"
                        :text="markDownInfo.goodDetail"
                    ></v-md-preview>
                    <v-md-preview
                        v-else
                        :text="markDownInfo.goodParams"
                    ></v-md-preview>
                </bk-tab-panel>
            </bk-tab>
        </div>
